...
/******************************************************************************
 * FunctionName : static void MotorHandling_get2ml()
 * Parameters   : none
 * Returns      : none
 *******************************************************************************/
static void MotorHandling_get2ml()
{
  int end = MOTOR_LIMIT;
...
/******************************************************************************
 * FunctionName : static void MotorHandling_get4ml()
 * Parameters   : void
 * Returns      : none
 *******************************************************************************/
//static void MotorHandling_get4ml()
//{
//  int end = MOTOR_LIMIT;
//  BAR_ERROR_CHECK(Gpio_set(MOTOR_AXE_Y_DIR, BAR_LEVEL_LOW));
//
